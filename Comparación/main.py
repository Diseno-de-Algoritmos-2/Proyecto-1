...
routes_paper, utilization_paper, best_dist_paper, exceution_time_paper = run_paper(CUSTOMERS, VEHICLE_CAPACITY, IF_PRINT)
routes_own, utilization_own, best_dist_own, exceution_time_own = run_own(CUSTOMERS, VEHICLE_CAPACITY, IF_PRINT)
# Guardar resultados
